<?php
    ...
    $config         = INSTANCE_ROOT . '/protected/config/main.php';//定义运用的配置文件
    // Yii is used from the common source.
    $yii            = COMMON_ROOT   . '/../yii/framework/yii.php';//定义yii类的路径

    // WebApplication is used from the common source.
    $webApplication = COMMON_ROOT   . '/protected/core/components/WebApplication.php';//定义yii运用实例路径

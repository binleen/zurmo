<?php
    ...
    class EmailCampaignsEditAndDetailsView extends SecuredEditAndDetailsView
    {
        ...
        {
            return Zurmo::t('EmailCampaignsModule', 'Create EmailCampaignsModuleSingularLabel',
        ...
        {
            return EmailCampaignsDetailsViewUtil::renderAfterFormLayoutForDetailsContent($this->getModel());
        }
    }
?>
